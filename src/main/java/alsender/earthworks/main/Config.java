...
public class Config {
    ...
    public static void load() {
        ...
        spawn_rate = config.getInt("spawn_rate", "world",3,0,42,"Attempts the world generator will make to spawn a CHALK vein per chunk.  Set to 0 to turn off CHALK.");
        ...
        gabion = config.getBoolean("gabion_particles", "block", true, "Set this to FALSE to DISABLE extra gabion particles.");
