...
public class Config {
    ...
    public static void load() {
        ...
        quark = config.getBoolean("generate_quark","compat",true,"Set this to false to disable Earthworks blocks that Quark also adds.  Currently includes: Thatch, and Reed Block");
