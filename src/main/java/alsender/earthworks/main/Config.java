...
public class Config {
    ...
    public static void load() {
        ...
        quark_compat = config.getBoolean("generate_quark","block",true,"Set this to false to disable Earthworks blocks that Quark also adds.  Currently includes: Thatch, and Reed Block");
