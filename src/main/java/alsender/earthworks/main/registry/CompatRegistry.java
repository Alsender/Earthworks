...
public class CompatRegistry {
    ...
    public static void initQuarkRecipe() {
        ...
        ModCraftingManager.addShapedRecipe("block_reed", new ItemStack(block_reed), 2, 2,
                Items.REEDS, Items.REEDS,
                Items.REEDS, Items.REEDS);

        ModCraftingManager.addShapedRecipe("block_thatch", new ItemStack(block_thatch),2,2,
    ...
    public static void initBTMRecipe() {
        ...
        ModCraftingManager.addShapedRecipe("block_dirt", new ItemStack(Blocks.DIRT),2,2,
                item_dirt, item_dirt,
                item_dirt, item_dirt);

        ModCraftingManager.addShapedRecipe("block_sand", new ItemStack(Blocks.SAND),2,2,
                item_sand, item_sand,
                item_sand, item_sand);

        ModCraftingManager.addShapelessRecipe("item_adobe", new ItemStack(ItemRegistry.item_adobe, 8),
        ...
        ModCraftingManager.addShapelessRecipe("item_dirt", new ItemStack(item_dirt, 4),
                Blocks.DIRT);

        ModCraftingManager.addShapelessRecipe("item_lime_plaster", new ItemStack(ItemRegistry.item_lime_plaster, 2),
                ItemRegistry.item_slaked_lime, item_sand);

        ModCraftingManager.addShapelessRecipe("item_lime_plaster_alt", new ItemStack(ItemRegistry.item_lime_plaster, 8),
        ...
        ModCraftingManager.addShapelessRecipe("item_mud", new ItemStack(ItemRegistry.item_mud, 8),
                item_dirt, item_dirt, item_dirt,
                item_dirt, Items.WATER_BUCKET, item_dirt,
                item_dirt, item_dirt, item_dirt);

        ModCraftingManager.addShapelessRecipe("item_sand", new ItemStack(item_sand, 4),
                Blocks.SAND);
    }
}