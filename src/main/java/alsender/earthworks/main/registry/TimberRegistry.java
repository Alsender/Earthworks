...
//Timber Logs
        ...
        ModCraftingManager.addShapedRecipe("block_timber_oak", new ItemStack(block_timber_oak, 3),1,3,
                new ItemStack(Blocks.LOG, 1, 0),
                new ItemStack(Blocks.LOG, 1, 0),
                new ItemStack(Blocks.LOG, 1, 0));

        ModCraftingManager.addShapedRecipe("block_timber_spruce", new ItemStack(block_timber_spruce, 3),1,3,
                new ItemStack(Blocks.LOG, 1, 1),
                new ItemStack(Blocks.LOG, 1, 1),
                new ItemStack(Blocks.LOG, 1, 1));

        ModCraftingManager.addShapedRecipe("block_timber_birch", new ItemStack(block_timber_birch, 3),1,3,
                new ItemStack(Blocks.LOG, 1, 2),
                new ItemStack(Blocks.LOG, 1, 2),
                new ItemStack(Blocks.LOG, 1, 2));

        ModCraftingManager.addShapedRecipe("block_timber_jungle", new ItemStack(block_timber_jungle, 3),1,3,
...
//Slabs/Stairs/Walls
        ...
        ModCraftingManager.addShapedRecipe("item_timber0", new ItemStack(item_timber, 6),1,2,
                block_timber_oak,
                block_timber_oak);
        ModCraftingManager.addShapedRecipe("item_timber1", new ItemStack(item_timber, 6),1,2,
                block_timber_spruce,
                block_timber_spruce);
        ModCraftingManager.addShapedRecipe("item_timber2", new ItemStack(item_timber, 6),1,2,
                block_timber_birch,
                block_timber_birch);
        ModCraftingManager.addShapedRecipe("item_timber3", new ItemStack(item_timber, 6),1,2,
                block_timber_jungle,
                block_timber_jungle);
        ModCraftingManager.addShapedRecipe("item_timber4", new ItemStack(item_timber, 6),1,2,
                block_timber_acacia,
                block_timber_acacia);
        ModCraftingManager.addShapedRecipe("item_timber5", new ItemStack(item_timber, 6),1,2,
        ...
        barndoor(daub_cob_barndoor0, block_wattle);
            ModCraftingManager.addShapelessRecipe("daub_cob_barndoor1", new ItemStack(daub_cob_barndoor1), daub_cob_barndoor0);
            ModCraftingManager.addShapelessRecipe("daub_cob_barndoor2", new ItemStack(daub_cob_barndoor2), daub_cob_barndoor1);
            ModCraftingManager.addShapelessRecipe("daub_cob_barndoor3", new ItemStack(daub_cob_barndoor3), daub_cob_barndoor2);
            ModCraftingManager.addShapelessRecipe("daub_cob_barndoor4", new ItemStack(daub_cob_barndoor4), daub_cob_barndoor3);
            ModCraftingManager.addShapelessRecipe("daub_cob_barndoor5", new ItemStack(daub_cob_barndoor5), daub_cob_barndoor4);
            ModCraftingManager.addShapelessRecipe("daub_cob_barndoor6", new ItemStack(daub_cob_barndoor6), daub_cob_barndoor5);
            ModCraftingManager.addShapelessRecipe("daub_cob_barndoor7", new ItemStack(daub_cob_barndoor7), daub_cob_barndoor6);
            ModCraftingManager.addShapelessRecipe("daub_cob_xdoor0", new ItemStack(daub_cob_xdoor0), daub_cob_barndoor7);
            ModCraftingManager.addShapelessRecipe("daub_cob_xdoor1", new ItemStack(daub_cob_xdoor1), daub_cob_xdoor0);
            ModCraftingManager.addShapelessRecipe("daub_cob_xdoor2", new ItemStack(daub_cob_xdoor2), daub_cob_xdoor1);
            ModCraftingManager.addShapelessRecipe("daub_cob_xdoor3", new ItemStack(daub_cob_xdoor3), daub_cob_xdoor2);
            ModCraftingManager.addShapelessRecipe("daub_cob_barndoor0", new ItemStack(daub_cob_barndoor0), daub_cob_xdoor3);
        ...
        square(daub_cob_square, block_wattle);
            ModCraftingManager.addShapelessRecipe("daub_cob_square_x", new ItemStack(daub_cob_square_x), daub_cob_square);
            ModCraftingManager.addShapelessRecipe("daub_cob_square", new ItemStack(daub_cob_square), daub_cob_x);
            ModCraftingManager.addShapelessRecipe("daub_cob_x", new ItemStack(daub_cob_x), daub_cob_square_x);
        ...
        barndoor(plaster_barndoor0, block_plaster);
            ModCraftingManager.addShapelessRecipe("plaster_barndoor1", new ItemStack(plaster_barndoor1), plaster_barndoor0);
            ModCraftingManager.addShapelessRecipe("plaster_barndoor2", new ItemStack(plaster_barndoor2), plaster_barndoor1);
            ModCraftingManager.addShapelessRecipe("plaster_barndoor3", new ItemStack(plaster_barndoor3), plaster_barndoor2);
            ModCraftingManager.addShapelessRecipe("plaster_barndoor4", new ItemStack(plaster_barndoor4), plaster_barndoor3);
            ModCraftingManager.addShapelessRecipe("plaster_barndoor5", new ItemStack(plaster_barndoor5), plaster_barndoor4);
            ModCraftingManager.addShapelessRecipe("plaster_barndoor6", new ItemStack(plaster_barndoor6), plaster_barndoor5);
            ModCraftingManager.addShapelessRecipe("plaster_barndoor7", new ItemStack(plaster_barndoor7), plaster_barndoor6);
            ModCraftingManager.addShapelessRecipe("plaster_xdoor0", new ItemStack(plaster_xdoor0), plaster_barndoor7);
            ModCraftingManager.addShapelessRecipe("plaster_xdoor1", new ItemStack(plaster_xdoor1), plaster_xdoor0);
            ModCraftingManager.addShapelessRecipe("plaster_xdoor2", new ItemStack(plaster_xdoor2), plaster_xdoor1);
            ModCraftingManager.addShapelessRecipe("plaster_xdoor3", new ItemStack(plaster_xdoor3), plaster_xdoor2);
            ModCraftingManager.addShapelessRecipe("plaster_barndoor0", new ItemStack(plaster_barndoor0), plaster_xdoor3);
        ...
        square(plaster_square, block_plaster);
            ModCraftingManager.addShapelessRecipe("plaster_square_x", new ItemStack(plaster_square_x), plaster_square);
            ModCraftingManager.addShapelessRecipe("plaster_square", new ItemStack(plaster_square), plaster_x);
            ModCraftingManager.addShapelessRecipe("plaster_x", new ItemStack(plaster_x), plaster_square_x);
    ...
    public static void arrow0(Block blockOut, Block blockIn) {
        ModCraftingManager.addShapedMirrorlessRecipe(blockOut.getUnlocalizedName(), new ItemStack(blockOut, 4),3,3,
                item_timber, blockIn, item_timber,
                item_timber, item_timber, blockIn,
    ...
    public static void arrow2(Block blockOut, Block blockIn) {
        ModCraftingManager.addShapedMirrorlessRecipe(blockOut.getUnlocalizedName(), new ItemStack(blockOut, 4),3,3,
                item_timber, blockIn, item_timber,
                blockIn, item_timber, item_timber,
                item_timber, item_timber, item_timber);
    }
    ...
    public static void bottom_l(Block blockOut, Block blockIn) {
        ModCraftingManager.addShapedMirrorlessRecipe(blockOut.getUnlocalizedName(), new ItemStack(blockOut, 5),3,3,
                item_timber, blockIn, blockIn,
                item_timber, blockIn, blockIn,
                item_timber, item_timber, item_timber);
    }
    public static void bottom_r(Block blockOut, Block blockIn) {
        ModCraftingManager.addShapedMirrorlessRecipe(blockOut.getUnlocalizedName(), new ItemStack(blockOut, 5),3,3,
                blockIn, blockIn, item_timber,
                blockIn, blockIn, item_timber,
                item_timber, item_timber, item_timber);
    }
    public static void left(Block blockOut, Block blockIn) {
        ModCraftingManager.addShapedMirrorlessRecipe(blockOut.getUnlocalizedName(), new ItemStack(blockOut, 4),3,3,
                item_timber, blockIn, ItemStack.EMPTY,
                item_timber, blockIn, ItemStack.EMPTY,
                item_timber, blockIn, ItemStack.EMPTY);
    }
    ...
    public static void right(Block blockOut, Block blockIn) {
        ModCraftingManager.addShapedMirrorlessRecipe(blockOut.getUnlocalizedName(), new ItemStack(blockOut, 4),3,3,
                ItemStack.EMPTY, blockIn, item_timber,
                ItemStack.EMPTY, blockIn, item_timber,
                ItemStack.EMPTY, blockIn, item_timber);
    }
    public static void slash(Block blockOut, Block blockIn) {
        ModCraftingManager.addShapedMirrorlessRecipe(blockOut.getUnlocalizedName(), new ItemStack(blockOut, 7),3,3,
                blockIn, blockIn, item_timber,
                blockIn, item_timber, blockIn,
                item_timber, blockIn, blockIn);
    }
